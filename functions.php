...
register_taxonomy("Categories", array("question","universities"), array("hierarchical" => true, "label" => "Categories", "singular_label" => "Categories", "rewrite" => true));
register_taxonomy("conflicts", array("question"), array("hierarchical" => true, "label" => "conflicts", "singular_label" => "conflicts", "rewrite" => true));

add_action('init', 'university_register');
 
function university_register() {
 
	$labels = array(
		'name' => _x('University', 'post type general name'),
		'singular_name' => _x('Universities', 'post type singular name'),
		'add_new' => _x('Add New', 'Universities'),
...
register_taxonomy("Faculty", array("universities"), array("hierarchical" => true, "label" => "Faculty", "singular_label" => "Faculty", "rewrite" => true));

register_taxonomy("State/Private", array("universities"), array("hierarchical" => true, "label" => "State/Private", "singular_label" => "State/Private", "rewrite" => true));

register_taxonomy("Town", array("universities"), array("hierarchical" => true, "label" => "Town", "singular_label" => "Town", "rewrite" => true));

register_taxonomy("Difficuly", array("question","universities"), array("hierarchical" => true, "label" => "Difficuly", "singular_label" => "Difficuly", "rewrite" => true));

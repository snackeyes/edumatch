...
?>
<button onclick="location.href ='exam1';"  >Start Exam</button>
<button onclick="location.href ='#';"  >Download Bill</button>
<button onclick="location.href ='#';"  >Download Result</button>
  <?php
